...
public class FireUnit extends ResponseUnit implements Dispatchable{

    public FireUnit(String unitID, String unitName, String baseLocation, boolean availability) {
        super(unitID, unitName, baseLocation, availability);
    }

    @Override
    public void showInfo() {
        System.out.print("Type: Fire Unit | ");
        super.showInfo();
    }
    ...
    public void response(Incident incident) {
        System.out.println("FireUnit response: controlling fire at " + incident.getLocation());
